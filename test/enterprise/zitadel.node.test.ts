...
test("enterprise oidc login interoperates with zitadel through api-driven flow", async () => {
  const {
    convexApiUrl,
    convexSiteUrl,
    zitadelBaseUrl,
...
test("enterprise saml login interoperates with zitadel through api-driven flow", async () => {
  const {
    convexApiUrl,
    convexSiteUrl,
    zitadelBaseUrl,
