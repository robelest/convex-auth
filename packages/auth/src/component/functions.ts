...
type ArgsFor<TArgs extends ArgsValidator | undefined> = TArgs extends PropertyValidators
  ? ObjectType<TArgs>
  : TArgs extends GenericValidator
    ? Infer<TArgs>
    : any;

type ReturnsFor<TReturns extends GenericValidator | undefined> = TReturns extends GenericValidator
  ? Infer<TReturns>
  : unknown;
