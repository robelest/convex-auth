...
export class SpMetadata extends Metadata {
  ...
  constructor(meta: MetadataSpConstructor) {
    const isFile = isString(meta) || meta instanceof Uint8Array;
    ...
    if (!isFile) {
      ...
      // Re-assign the meta reference as a XML string|Uint8Array for use with the parent constructor
      meta = buildXml([
        {
          EntityDescriptor: [
            {
    ...
    super(meta as string | Uint8Array, [
      {
        key: "spSSODescriptor",
