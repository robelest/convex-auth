...
- **Every auth method** — Password, OAuth (50+ providers via Arctic), magic
  links, passkeys, TOTP, anonymous, phone, device flow (RFC 8628)
- **Enterprise SSO** — OIDC, SAML 2.0, SCIM 2.0 via `new SSO()` with conditional
  TypeScript gating
...
| [Enterprise SSO](https://convex-auth.pages.dev/sso/overview/)                  | OIDC, SAML, SCIM, audit, webhooks                               |
